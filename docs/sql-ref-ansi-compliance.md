...
| Source\Target  | Numeric | String | Date  | Time | Timestamp | Timestamp\_NTZ | Interval | Boolean | Binary | Array | Map   | Struct |
| -------------- | ------- | ------ | ----- | ---- | --------- | -------------- | -------- | ------- | ------ | ----- | ----- | ------ |
...
| Timestamp\_NTZ | N       | Y      | Y     | N    | Y         | Y              | N        | N       | N      | N     | N     | N      |
...
* CAST(String AS (Numeric/Date/Timestamp/Timestamp\_NTZ/Interval/Boolean)): raise a runtime exception if the value can't be parsed as the target data type.
...
| Float     | Float -> Double                                                                    |
| Double    | Double                                                                             |
| Date      | Date -> Timestamp\_NTZ -> Timestamp                                                |
| Time      | Time                                                                               |
| Timestamp | Timestamp                                                                          |
| String    | String, Long -> Double, Date -> Timestamp\_NTZ -> Timestamp , Boolean, Binary \*\* |
| Binary    | Binary                                                                             |
| Boolean   | Boolean                                                                            |
| Interval  | Interval                                                                           |
| Map       | Map\*\*\*                                                                          |
...
This is a graphical depiction of the precedence list as a directed tree: ![Type Precedence List](../.gitbook/assets/type-precedence-list.png)
...
| Keyword            | <p>Spark SQL<br>ANSI Mode</p> | <p>Spark SQL<br>NonANSI Mode</p> | SQL-2016      |
| ------------------ | ----------------------------- | -------------------------------- | ------------- |
...
| ANY\_VALUE         | non-reserved                  | non-reserved                     | non-reserved  |
...
| CURRENT\_DATABASE  | non-reserved                  | non-reserved                     | non-reserved  |
| CURRENT\_DATE      | reserved                      | non-reserved                     | reserved      |
| CURRENT\_PATH      | reserved                      | non-reserved                     | reserved      |
| CURRENT\_SCHEMA    | reserved                      | non-reserved                     | reserved      |
| CURRENT\_TIME      | reserved                      | non-reserved                     | reserved      |
| CURRENT\_TIMESTAMP | reserved                      | non-reserved                     | reserved      |
| CURRENT\_USER      | reserved                      | non-reserved                     | reserved      |
...
| DATE\_ADD          | non-reserved                  | non-reserved                     | non-reserved  |
| DATEDIFF           | non-reserved                  | non-reserved                     | non-reserved  |
| DATE\_DIFF         | non-reserved                  | non-reserved                     | non-reserved  |
...
| DEFAULT\_PATH      | non-reserved                  | non-reserved                     | not a keyword |
...
| SESSION\_USER      | reserved                      | non-reserved                     | reserved      |
...
| SYSTEM\_PATH       | non-reserved                  | non-reserved                     | not a keyword |
| SYSTEM\_TIME       | non-reserved                  | non-reserved                     | non-reserved  |
| SYSTEM\_VERSION    | non-reserved                  | non-reserved                     | non-reserved  |
...
| TIMESTAMP\_LTZ     | non-reserved                  | non-reserved                     | non-reserved  |
| TIMESTAMP\_NTZ     | non-reserved                  | non-reserved                     | non-reserved  |
...
| TRY\_CAST          | non-reserved                  | non-reserved                     | non-reserved  |
